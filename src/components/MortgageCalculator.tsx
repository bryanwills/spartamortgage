...
const MortgageCalculator = () => {
  ...
  const handleCreditScoreChange = (creditScore: string) => {
    ...
    setFormData(prev => ({
      ...prev,
      creditScore,
      interestRate: selectedScore?.rate || 6.5
    }));
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-xl">
            ...
            {results.chartData.length > 0 && (
              <div className="mt-8 bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-sm border border-white/20">
                ...
                {formData.extraPayment > 0 && results.extraPaymentResults && (
                  <div className="mt-4 p-4 bg-green-500/20 backdrop-blur-md rounded-xl">
                    <h4 className="font-semibold text-green-300 mb-2">Impact of ${formData.extraPayment} Extra Monthly Payment:</h4>
