...
import { Search, Filter, MapPin, DollarSign, Bed, Bath, Square, Calendar, Star, Heart, Share2, Phone, Mail } from 'lucide-react'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent dark:bg-gray-700 dark:text-white text-gray-900 dark:text-white"
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent dark:bg-gray-700 dark:text-white text-gray-900 dark:text-white"
                      suppressHydrationWarning
                    />
                  </div>
                  <div className="relative flex-1">
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <select
                      ...
                      className="w-full pl-8 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent dark:bg-gray-700 dark:text-white text-gray-900 dark:text-white appearance-none"
                      suppressHydrationWarning
                    >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 pr-8 focus:ring-2 focus:ring-red-500 focus:border-transparent dark:text-white text-gray-900 dark:text-white"
                  suppressHydrationWarning
                >
