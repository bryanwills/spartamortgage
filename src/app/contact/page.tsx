        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Get your free consultation and see why over 700 clients have trusted us with their mortgage needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="text-white">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/90">Kentucky, Indiana, Florida & Georgia</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+15028191739" className="text-white/90 hover:text-yellow-300 transition-colors">
                      (502) 819-1739
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:nathan@spartamortgage.com" className="text-white/90 hover:text-yellow-300 transition-colors">
              ...
              <div className="mt-12 bg-white/10 backdrop-blur-md rounded-xl p-6">
                <h4 className="text-xl font-bold mb-4">Why Choose Sparta Over Banks?</h4>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-yellow-300 flex-shrink-0" />
                    <span className="text-white/90">Creative problem solving</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-yellow-300 flex-shrink-0" />
