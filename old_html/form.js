...
(function() {
    ...
    var _form_serialize = function(form) {
        ...
        {case"tel":q.push(form.elements[i].name+"="+encodeURIComponent(form.elements[i].previousSibling.querySelector('div.iti__selected-dial-code').innerText+encodeURIComponent(" ")+encodeURIComponent(form.elements[i].value));
        break;
        case"text":
        case"number":
        case"date":
    ...
    // var form_submit = function(e) {
        document.getElementById('_form_1_').addEventListener('submit', function(e) {
        e.preventDefault();
        if (validate_form()) {
            ...
            async function submitForm() {
              ...
              const response = await fetch('proc.php?jsonp=true', {
                headers: {
            ...
            _load_script('proc.php?' + serialized + '&jsonp=true', null, true);
            }
        }
        return false;
    });
